    ...
    <View style={styles.container}>
      <StatusBar translucent backgroundColor="transparent" />
        <View style={{ flexDirection:'row',paddingHorizontal:30, paddingTop:40}}>
          ...
          <Text style={{fontSize: 34, color: '#757575',fontFamily: 'AnekLatin-SemiBold'}}>Aut</Text>
           <LottieView
            source={require('@Assets2/image/steer.json')} autoPlay loop
            style={{ width:30, height:30,resizeMode:'contain', marginTop:5}}
             />
             <Text style={{fontSize: 54,color: '#757575',fontFamily: 'AnekLatin-SemiBold', marginTop:-15}}>Q</Text>
        </View>

        

      <Image source={require('@Assets2/image/keke.png')} style={styles.carImg} />
