...
const FormStateDetailsWorker = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    const submit = async (data) => {
      ...
      const result = lga.filter(lgaa => lgaa.id === lgaId)
        ...
        navigation.navigate("FormImageUploadWorker");
    ...
    return (
        ...
        <View style={styles.mainContainer}>
            ...
            <View style={styles.signupPinTitleContainer}>
                ...
                <Text style={styles.signupTitle}>Specialization & Location</Text>

                <Text style={styles.signupDesc}>Area of profession</Text>
                            ...
                            contentContainerStyle={styles.scrollViewContainer}>
                                ...
                                <View style={styles.scrollViewTop}>
                                   ...
                                   <View style={styles.countryCodeView}>
                                    <TouchableOpacity style={styles.profBtn} onPress={changeProf}>
                                        <Text style={styles.profText}>{proffesion}</Text>
                                        <View style={styles.clickCover}>
                                            <Text style={styles.clickBtn}>Click to change profession</Text>
                                        </View>
                                    </TouchableOpacity>
                                   </View>
...
export default FormStateDetailsWorker;