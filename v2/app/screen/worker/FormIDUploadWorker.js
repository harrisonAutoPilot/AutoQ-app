...
const FormIDUploadWorker = ({ navigation }) => {
...
const useUpload =()=>{
    ...
    const submit = async () => {
        ...
        navigation.navigate("FormGuarrantorWorker");
    ...
    return (
        ...
        <View style={styles.mainContainer}>
            ...
            {!uploadIsHere ? 
                <>
                <Text style={styles.signupTitle}>Add ID Card</Text>
...
export default FormIDUploadWorker;