...
const FormImageUploadWorker = ({ navigation }) => {
...
const useUpload =()=>{
    ...
    const submit = async () => {
        ...
        navigation.navigate("FormIDUploadWorker");
                            ...
                            contentContainerStyle={styles.scrollViewContainer}>
                                ...
                                <SafeAreaView>
                                    ...
                                    <View style={styles.avartarCover}>
                                        ...
                                        <Text style={styles.bgText}>Profile Photo Captured Successful</Text>
...
export default FormImageUploadWorker;