...
const FormIDUploadDealer = ({ navigation }) => {
...
const useUpload =()=>{
    ...
    const submit = async () => {
        ...
        navigation.navigate("SignUpPinDealer");
    ...
    return (
        ...
        <View style={styles.mainContainer}>
            ...
            {!uploadIsHere ? 
                <>
                <Text style={styles.signupTitle}>Add Dealer ID Card</Text>

                <Text style={styles.signupDesc}>Add valid ID, (Drivers Licence, National ID Card, Voters Card, International Passport)</Text>
                </>
                :
                null
                        ...
                        <Text style={styles.errText}>{errMsg}</Text>
                            ...
                            contentContainerStyle={styles.scrollViewContainer}>
                                ...
                                <SafeAreaView>
                                    ...
                                    // />
                                    <LottieView
                                    source={require('@Assets2/image/Comp_2.json')} autoPlay loop
                                    style={{width:400,height:400,alignSelf:'center', marginTop:-50, zIndex:1}}
                                    />
                                    :
                                    <View style={styles.avartarCover}>
                                        ...
                                        <Text style={styles.bgText}>ID Card Captured Successful</Text>
...
export default FormIDUploadDealer;