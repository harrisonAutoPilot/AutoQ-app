...
const FormDetailsDealer = ({ navigation }) => {
    ...
    console.log("the other name", data)
        ...
        navigation.navigate("FormStateDetailsDealer");
    ...
    return (
        ...
        <View style={styles.mainContainer}>
            ...
            <LoginHeader
                ...
                <Image source={require('@Assets2/image/istockphoto-1034249292-612x612.jpeg')}
                 style={styles.carImg} />
                </View>
            <SafeAreaView>
...
export default FormDetailsDealer;