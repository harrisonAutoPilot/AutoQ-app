...
const RenderItem = ({ item }) => {
  ...
  return (
              ...
              <View>
                  {
                      selected !== item.id
                          ?
                          <MIcon name="downcircleo" size={18} color="#9ACD32" />
                          :
                          <MIcon name="upcircleo" size={18} color="#9ACD32" />
                  }
    ...
    return (
  <SafeAreaView>
                 <BottomSheet hasDraggableIcon sheetBackgroundColor="#fff" ref={props.bottomSheetService} height={500} >

                   <View style={styles.sheetContainer}>
                   <View style={styles.signupMiniTitleContainer}>
                      <Text style={styles.signupTitle}>My Services</Text>
                      <Text style={styles.signupDesc}>Feel free to call and ask for any service out of the list</Text>
                   </View>
