...
const Overlay = (props) => {
 ...
 const toastConfig = {
    ...
    const AddStore = () => (
        <BottomSheet hasDraggableIcon ref={props.bottomSheetAddStore} sheetBackgroundColor={'#ffffff'} height={Dimensions.get("window").height / 1.25} radius={50} styles={styles.addStoreBottomSheet}>
