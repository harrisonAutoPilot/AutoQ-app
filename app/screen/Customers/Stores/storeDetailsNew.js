...
import { Btn, BtnPre, FormikValidator, InputField, SuccessMsgViewTwo } from "@Component/index";
...
const Overlay = (props) => {
 ...
 const toastConfig = {
    ...
    const StoreDetail = () => (
        <BottomSheet hasDraggableIcon ref={props.bottomSheetStoreDetail} sheetBackgroundColor={'#ffffff'} height={Dimensions.get("window").height / 1.05} radius={50} styles={styles.addStoreBottomSheet}>

           
           
                <View style={styles.modalPadding}>
                    <TouchableOpacity  onPress={props.closeSheet3} style={styles.backCover}>
